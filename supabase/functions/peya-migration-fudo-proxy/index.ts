...
const FUDO_BASE_URL = 'https://api.fu.do';
const APP_BASE_URL = 'https://app-v2.fu.do';
...
Deno.serve(async (req) => {
    ...
    try {
        const { path, method, token, clusterId, forwardBody, contentType } = await parseProxyPayload(req);
        ...
        const fudoUrl = new URL(normalizedPath, `${FUDO_BASE_URL}/`).toString();
        ...
        headers['Referer'] = `${APP_BASE_URL}/app/`;
